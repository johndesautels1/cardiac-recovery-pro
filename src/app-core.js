...
function navigateDate(days) {
    ...
    try {
        ...
        console.warn('Non-fatal: update on date change failed:', e);
    }
}
...
function saveMetrics() {
    ...
    // Safely attach GPS location if captured (robust with validation)
    // Ensures location data is properly normalized before saving
    if (capturedLocation && capturedLocation.coords && typeof capturedLocation.coords.latitude === 'number') {
        metrics.location = {
            latitude: capturedLocation.coords.latitude,
            longitude: capturedLocation.coords.longitude,
            accuracy: capturedLocation.coords.accuracy || null,
            label: capturedLocation.label || '',
            googleMapsUrl: capturedLocation.googleMapsUrl || `https://www.google.com/maps?q=${capturedLocation.coords.latitude},${capturedLocation.coords.longitude}`
        };
